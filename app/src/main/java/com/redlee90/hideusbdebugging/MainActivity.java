...
public class MainActivity extends AppCompatActivity {
    ...
    private class LoadAppListAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            SharedPreferences sharedPreferences = getSharedPreferences("tickedApps", MODE_WORLD_READABLE + MODE_WORLD_WRITEABLE);
            try {
        ...
        protected void onPostExecute(Void aVoid) {
            recyclerViewAdapter = new appListRecyclerViewAdapter(MainActivity.this, appList, tickedPackages);
